...
class PurchaseOrderLine(models.Model):
    ...
    def onchange_product_id(self):
        purchase_line = self.with_context(
            all_attributes=self.product_attribute_ids)
        res = super(PurchaseOrderLine, purchase_line).onchange_product_id()
        return res
    ...
    def onchange_product_id_product_configurator(self):
        purchase_line = self.with_context(
            all_attributes=self.product_attribute_ids)
        res = super(PurchaseOrderLine, purchase_line
                    ).onchange_product_id_product_configurator()
